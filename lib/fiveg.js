...
var FIVEG = function(){
  ...
  // thanks: https://stemkoski.github.io/Three.js/Sprite-Text-Labels.html
  var make_text_sprite = function(message, options){
    if(options === undefined){
      var options = {};
    }

    var font_face = options.hasOwnProperty('fontface') ? 
      options['fontface'] : 'Arial';

    var font_size = options.hasOwnProperty('fontsize') ?
      options['fontsize'] : 12;
    
    var border_thickness = options.hasOwnProperty('borderthickness') ?
      options['borderthickness'] : 4;

    // backgroundcolor
    var bgc = options.hasOwnProperty('backgroundcolor') ?
    ...
    context.strokeStyle = 'rgba(' + bgc.r + ',' + bgc.g + ',' + bgc.b + ',' + bgc.a + ')';

    context.fillStyle = 'rgba(0,0,0,1.0)';
    context.fillText(message, border_thickness, font_size + border_thickness);
